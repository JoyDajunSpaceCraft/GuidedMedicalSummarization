...
fair_logging.basicConfig(
    format='%(asctime)s | %(levelname)s | %(name)s | %(message)s',
    datefmt='%Y-%m-%d %H:%M:%S',
    level=fair_logging.INFO,
    stream=sys.stdout,
)
...
def main(args):
    ...
    # args.trainpref = "/Users/yuelyu/PycharmProjects/guided_summarization-master/bart/bpe_output_data/train.bpe"
    # args.validpref = "/Users/yuelyu/PycharmProjects/guided_summarization-master/bart/bpe_output_data/val.bpe"
    # args.destdir = "/Users/yuelyu/PycharmProjects/guided_summarization-master/bart/bin_output_data"
    # args.workers = 60
    # args.srcdict = dict.txt
    # args.tgtdict = dict.txt
    os.makedirs(args.destdir, exist_ok=True)

    logger.addHandler(fair_logging.FileHandler(
