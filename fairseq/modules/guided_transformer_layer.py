...
class GuidedTransformerDecoderLayer(nn.Module):
    """Decoder layer block.
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def forward(
            ...
            z_encoder_out: Optional[torch.Tensor] = None,
            z_encoder_padding_mask: Optional[torch.Tensor] = None,
            z_prev_attn_state: Optional[List[torch.Tensor]] = None,
    ):
        """
        Args:
