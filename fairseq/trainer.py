...
from fairseq.fair_logging import meters, metrics
...
class Trainer(object):
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        # gather fair_logging outputs from all replicas
        if self._sync_stats():
    ...
    def _all_gather_list_sync(
        ...
        *extra_stats_to_sum,
        ...
        """
        Sync fair_logging outputs across workers. all_gather_list_sync is
        suitable when fair_logging outputs are complex types.
        """
        if ignore:
            logging_outputs = []
        results = list(zip(
    ...
    def _fast_stat_sync_sum(
        ...
        *extra_stats_to_sum,
        ...
        """
        Sync fair_logging outputs across workers. fast_stat_sync_sum is
        faster than all_gather_list_sync, but is only suitable when
        fair_logging outputs are scalars and can be summed. Note that
